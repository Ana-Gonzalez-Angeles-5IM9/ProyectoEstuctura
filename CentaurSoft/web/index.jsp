<%-- 
    Document   : index
    Created on : 6/10/2018, 08:39:39 PM
    Author     : Ana
--%>
...
<header class="w3-display-container w3-center">
  ...
  <div class="mySlides w3-animate-opacity">
      <img class="w3-image" src="img/celular.jpg" alt="Image 1" style="min-width:500px" width="100%" height="200">
  ...
  <div class="mySlides w3-animate-opacity">
      <img class="w3-image" src="img/distractor.jpg" alt="Image 2" style="min-width:500px" width="100%" height="200">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge w3-text-red"><b>!</b> Easy</h1>
        <hr class="w3-opacity">
        <p>:)</p>
  ...
  <div class="mySlides w3-animate-opacity">
      <img class="w3-image" src="img/trabajo.jpeg" alt="Image 3" style="min-width:500px" width="1500" height="1000">
    <div class="w3-display-left w3-padding w3-hide-small" style="width:35%">
      <div class="w3-black w3-opacity w3-hover-opacity-off w3-padding-large w3-round-large">
        <h1 class="w3-xlarge">hey</h1>
        <hr class="w3-opacity">
        <p>C:</p>
...
<div class="w3-padding-64 w3-white">
  <div class="w3-row-padding">
    ...
    <div class="w3-col l4 m6">
        <img src="img/mejorar.jpg" class="w3-image w3-right w3-hide-small" width="335" height="471">
...
<div class="w3-padding-64 w3-light-grey">
  <div class="w3-row-padding">
    <div class="w3-col l4 m6">
        <img class="w3-image w3-round-large w3-hide-small w3-grayscale" src="img/yep.jpg" alt="App" width="335" height="471">
    </div>
    <div class="w3-col l8 m6">
    ...
    <div class="w3-half w3-section">
      <ul class="w3-ul w3-card w3-hover-shadow">
        ...
        <li class="w3-light-grey w3-padding-24">
          ...
          <button class="bubbly-button" onclick="location.href='login.jsp'">Descargar!</button>
        </li>
      </ul>
    </div>
    <div class="w3-half w3-section">
